...
The optimized release was then measured live at performance 86 and accessibility 100. FCP was 2.5 s, LCP 3.6 s, TBT 40 ms, CLS 0 and transferred page weight 451 KiB. Lighthouse's unused-JavaScript estimate fell from about 109 KiB to about 92 KiB. These individual simulated runs vary with network and server timing, but the transferred-byte and bundle-size reductions are deterministic build results.
