...
Still open: delayed refund failure/reversal handling, provider sandbox end-to-end journeys, operational alert receipt and owner reconciliation of historical payments. Gift refunds against spent credit require an operator to reconcile the original purchase and associated bookings; the code deliberately does not invent a debt or charge the customer. Do not mark commercial payments cleared from these tests alone.
