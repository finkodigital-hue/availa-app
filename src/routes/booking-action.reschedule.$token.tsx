...
function ReschedulePage() {
  ...
  const [state, setState] = useState<
    "loading" | "picking" | "submitting" | "done" | "error"
  >("loading");
  ...
  const theme =
    peek && peek.ok && peek.theme ? parseTheme(peek.theme) : defaultTheme();
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          borderColor:
            "color-mix(in oklab, var(--brand-text) 12%, transparent)",
        }}
      >
        {state === "loading" && (
        ...
        {state === "error" && (
          <div className="text-center py-8">
            ...
            >
              It may have expired, already been used, or the booking has changed
        ...
        {state === "done" && (
          <div className="text-center py-8">
            ...
            <p
              ...
              style={{ color: "var(--brand-text-muted)" }}
            >
              We've updated your appointment time.
            </p>
          </div>
        )}
        ...
        <Link
          to="/"
          className="block text-center mt-6 text-xs font-medium"
          style={{ color: "var(--brand-text-muted)" }}
        >
      ...
      <div className="min-h-[140px] max-h-[240px] overflow-y-auto mt-4">
        ...
        {!isLoading && slots.length === 0 && (
          <div
            ...
            style={{ color: "var(--brand-text-muted)" }}
          >
            No available times this day. Try another date.
          </div>
        )}
        {!isLoading && slots.length > 0 && (
