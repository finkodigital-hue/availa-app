...
export const HELP_CATEGORIES: HelpCategory[] = [
  ...
  },
  {
    ...
    title: "Import",
    description:
      "Bring your team, clients, services and history over from another system.",
    icon: "Upload",
  },
];
...
export const HELP_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        type: "p",
        text: "Submitting creates your workspace with default hours of Monday–Friday 9am–5pm, closed Saturday and Sunday, and takes you straight to your dashboard. You can change your hours any time in Settings → Hours.",
      },
      {
        type: "note",
        text: "There's currently no way to change your booking page URL from within the app once it's set, so it's worth picking one you're happy with.",
      },
    ],
  ...
  },
  {
    ...
    blocks: [
      {
        type: "p",
        text: 'Once your workspace is created, add a few services and staff, then open Page Builder — the first visit launches a four-step setup wizard that builds a starting page from your real services and staff. See "The setup wizard: building your first page" in Booking Page & Page Builder for the full walkthrough.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    blocks: [
      {
        type: "p",
        text: 'Your booking page lives at bookzenvo.com/book/your-slug. You can find and copy it from the top of the sidebar, from "Preview page" in the sidebar footer, or from the "Booking page" link on your dashboard.',
      },
      {
        type: "p",
        text: 'Share this link anywhere — your Instagram bio, Google listing, or a text reply to "are you free Saturday?"',
      },
    ],
  },
  {
  ...
  // ---------------------------------------------------------------------
  {
    ...
    blocks: [
      {
        type: "p",
        text: "Open Page Builder from the sidebar to edit the public page clients see at your /book link. It has two tabs.",
      },
      {
        type: "list",
        items: [
          "Sections - the content of your page: hero, about, gallery, services, staff, verified reviews, hours and location.",
          "Design — colors, fonts, button style and corner radius for the whole page.",
        ],
      },
      {
        type: "p",
        text: 'If you haven\'t finished setting up your page yet, opening Page Builder drops you into the setup wizard instead — see "The setup wizard: building your first page."',
      },
    ],
  },
  {
    ...
    summary:
      "A four-step wizard that generates a starting page from your real services and staff.",
    blocks: [
      {
        type: "p",
        text: "New businesses are dropped into a full-screen setup wizard the first time they open Page Builder. It has four steps.",
      },
      {
        type: "steps",
        items: [
      ...
      {
        type: "note",
        text: "Your progress autosaves as you go, so you can leave and come back. You can re-run the wizard any time from the Design panel.",
      },
    ],
  },
  {
    ...
    blocks: [
      {
        type: "p",
        text: 'On the Sections tab, click "Edit manually" to expand the block editor. Your page is built from these block types:',
      },
      {
        type: "list",
        items: [
      ...
      {
        type: "p",
        text: 'Use "Add block" to insert a new section, drag blocks to reorder them, and use the up/down/remove controls on each one. Click Save when you\'re done.',
      },
      {
        type: "note",
        text: "There's no separate draft mode — clicking Save publishes your changes to the live page immediately.",
      },
    ],
  ...
  },
  {
    ...
    summary:
      "Describe a change in plain English and review it before it goes live. Studio plan only.",
    studioOnly: true,
    blocks: [
      {
        type: "p",
        text: 'On Studio plans, the Sections tab includes a box above the manual editor: "Describe what you want to change." Type something like "Make the hero punchier, add a gallery of my work, and feature Jen and Leanne," then click Suggest changes.',
      },
      {
        type: "p",
        text: "This isn't a chat - each request is a single suggestion. Bookzenvo takes a screenshot of your current page, sends it along with your prompt, and generates a full replacement layout using only your real services and staff. Verified customer reviews cannot be written or changed by AI.",
      },
      {
        type: "steps",
        items: [
      ...
      {
        type: "note",
        text: "Nothing is saved until you approve it. On the Free plan, this box is replaced with an upgrade prompt — AI page editing isn't available on Free.",
      },
    ],
  ...
  },
  {
    ...
    blocks: [
      {
        type: "p",
        text: "Open Page Builder → Design to style your whole page at once.",
      },
      {
        type: "list",
        items: [
      ...
      {
        type: "p",
        text: 'Click "Save design" to publish your changes immediately. Your logo is set during Step 1 of the setup wizard; to change it, use "Re-run setup wizard" from the Design tab.',
      },
      {
        type: "note",
        text: "In Settings, the old Branding tab now just links here — all page styling lives in Page Builder → Design.",
      },
    ],
  ...
  },
  {
    ...
    blocks: [
      {
        type: "p",
        text: 'Click "History" at the top of Page Builder to see your last 20 saved versions, each with a timestamp and the prompt used (or "Manual edit" if you edited blocks by hand).',
      },
      {
        type: "p",
        text: "Click Restore on any entry to bring your page back to that version. You'll be asked to confirm, since restoring saves immediately and replaces your current layout — it isn't a preview.",
      },
    ],
  ...
  },
  {
    ...
    blocks: [
      {
        type: "p",
        text: "Open Preview from the sidebar to see your live booking page exactly as a client would. Toggle between Mobile and Desktop widths, and use Refresh to pick up your latest changes.",
      },
      {
        type: "p",
        text: 'Click "Open live" to view the real page at your /book link in a new tab.',
      },
    ],
  },
  {
    ...
    blocks: [
      {
        type: "p",
        text: "Clients book through a simple stepper on your public page:",
      },
      {
        type: "steps",
        items: [
      ...
      {
        type: "p",
        text: "Clients can use the chips at the top of the page to jump back and change an earlier choice at any point.",
      },
    ],
  },
  ...
  // ---------------------------------------------------------------------
  {
    ...
    blocks: [
      {
        type: "p",
        text: "Add and edit services from the Services page. Each service has:",
      },
      {
        type: "list",
        items: [
      ...
      {
        type: "note",
        text: "Deposits aren't set per service — configure a deposit or full-payment requirement for your whole business under Settings → Payments.",
      },
      {
        type: "p",
        text: "You can archive a service to hide it while keeping its booking history, or delete it — deleting is blocked if the service has existing bookings, and you'll be guided to archive instead.",
      },
    ],
  },
  {
    ...
    summary:
      "Track how much stock a service uses, and see its real profit margin.",
    blocks: [
      {
        type: "p",
        text: 'On a service\'s edit form, use "Attach stock item" to choose an item from Stock, or create one without leaving the service. Set how much is used for each appointment to see the estimated appointments remaining.',
      },
      {
        type: "note",
        text: "Linked quantities are deducted automatically when a booking is completed. If a completion is reversed, the recorded stock deduction is restored.",
      },
    ],
  ...
  },
  {
    ...
    blocks: [
      {
        type: "p",
        text: "Add team members from the Staff page: name, role, email, phone, bio and a photo. Two toggles control visibility — Bookable (shown on your booking page) and Active (disable to hide them everywhere without deleting them).",
      },
      ...
      {
        type: "note",
        text: "The Free plan allows one staff member; Studio allows unlimited staff.",
      },
      {
        type: "p",
        text: "If you remove a staff member who has future bookings, you'll be asked to reassign those bookings to another active staff member before they're disabled.",
      },
    ],
  },
  {
    ...
    summary:
      "Give a staff member their own schedule, separate from your business hours.",
    blocks: [
      {
        type: "p",
        text: "Open a staff member's edit dialog → Hours to set an open and close time for each day of the week, with a toggle to mark a day closed.",
      },
      {
        type: "note",
        text: "These hours override your general business hours for that person. Leave every day closed to have them simply inherit your business hours instead.",
      },
    ],
  ...
  },
  {
    ...
    summary:
      "Block out holidays, sick days and breaks so clients can't book over them.",
    blocks: [
      {
        type: "p",
        text: "Open a staff member's edit dialog → Time off to block bookings automatically for holidays, vacations, sick leave, breaks, training or anything else.",
      },
      {
        type: "steps",
        items: [
      ...
      {
        type: "p",
        text: 'Leave the staff member field blank to block time for your whole team at once — these show an "All staff" badge. Deleting a time-off entry reopens those slots for booking immediately.',
      },
    ],
    keywords: [
      "annual leave",
  ...
  },
  {
    ...
    summary:
      "Invite self-employed renters who run their own bookings under your roof.",
    blocks: [
      {
        type: "p",
        text: "Professionals are different from staff: each is a self-employed renter with their own separate Bookzenvo account and business, linked to yours. They keep their own bookings, clients and payments, but can appear on your shared calendar and booking page.",
      },
      {
        type: "p",
      ...
      {
        type: "note",
        text: 'There\'s no "resend" option — only Copy invite link and Revoke on a pending invite. Invitations expire, so re-copy and resend the link if needed.',
      },
      {
        type: "p",
        text: "On the Rent tab, track payments by status (Due, Overdue, Paid, Waived), generate the next period for weekly/monthly agreements, or add one-off payments for commission-based agreements. Each professional's permissions on your calendar and booking page can be adjusted under Settings → Chair rentals.",
      },
    ],
  ...
  },
  {
    ...
    summary:
      "Add a booking yourself, or block time without a customer attached.",
    blocks: [
      {
        type: "p",
        text: 'Click "New booking," or click directly on an empty slot in the calendar, to open the booking dialog. Work through customer, service, staff and time, then confirm.',
      },
      {
        type: "p",
        text: 'Toggle "Custom" in the dialog to block time without attaching a customer — useful for a walk-in placeholder or blocking your own time for something other than a booking.',
      },
    ],
  ...
  },
  {
    ...
    blocks: [
      {
        type: "p",
        text: "In Day view, drag a booking to a new time or staff column to reschedule it, or drag its edge to resize the duration. Bookzenvo re-checks working hours and blocked time before allowing the move, and shows an Undo option straight after.",
      },
      {
        type: "note",
        text: "Bookzenvo filters out times that clash with an existing booking or blocked time as you browse the calendar. Your public booking page also double-checks on the server the instant a client confirms, so two clients can't both grab the same slot even if they were looking at it at the same time.",
      },
    ],
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        type: "p",
        text: "Open a booking to change its status from the status grid in the detail dialog, or use the Cancel button.",
      },
    ],
  },
  {
    ...
    summary:
      "A searchable, filterable table view — an alternative to the calendar.",
    blocks: [
      {
        type: "p",
        text: "The Bookings page lists appointments as a flat, searchable table rather than a calendar grid. Search by client name, email, phone or service, and filter by period (Upcoming, Past, All time) or status. It shows up to 200 results at a time.",
      },
      {
        type: "p",
        text: "Clicking a row opens the same booking detail dialog you'd get from the calendar, with the same status and cancel controls.",
      },
    ],
  },
  {
    ...
    blocks: [
      {
        type: "p",
        text: "The bell icon in the sidebar notifies you, the business owner, whenever a booking is created or cancelled.",
      },
      {
        type: "note",
  ...
  // ---------------------------------------------------------------------
  {
    ...
    blocks: [
      {
        type: "p",
        text: "Customer records build themselves automatically from bookings — Bookzenvo matches new bookings to an existing customer by email or phone, or creates a new record. You can also add or edit customers by hand from the Customers page.",
      },
      {
        type: "p",
        text: "Each record holds name, email, phone, address, a photo and private notes (never visible to the customer themselves). Opening a customer shows their visit count, total spend, average spend and favourite service, all calculated from their real booking history, alongside Upcoming and History tabs.",
      },
    ],
  },
  {
    ...
    blocks: [
      {
        type: "p",
        text: "Clients have their own self-serve area at /portal, separate from your dashboard. They sign in with just their email and a one-time 6-digit code — no password, and no separate sign-up step.",
      },
  ...
  // ---------------------------------------------------------------------
  {
    ...
    blocks: [
      {
        type: "p",
        text: "Add products from the Stock page: name, brand, category, unit (ml, g, unit, bottle, or your own), starting stock, a low-stock threshold, and cost.",
      },
      {
        type: "p",
        text: "Categories group items into an easy-to-scan product shelf. Choose one of the starting categories or type your own category name.",
      },
      {
        type: "note",
        text: "If you leave the low-stock threshold blank on a new item, it's set automatically to 20% of your starting stock.",
      },
      {
        type: "p",
        text: 'Adjust quantities with the quick +/- buttons on each item, or open "Adjust" for quick deltas (+50, +10, -5, -1) or a custom signed amount. You can also edit or delete an item entirely.',
      },
      {
        type: "note",
        text: "There's no adjustment history log — each adjustment simply updates the current quantity, so it's worth keeping your own restock records if you need an audit trail.",
      },
    ],
  },
  {
    ...
    blocks: [
      ...
      {
        type: "p",
        text: "When something needs attention, a banner appears at the top of the Stock page. Use Review to show only the items that are low or out, and use the category buttons to narrow the shelf.",
      },
      {
        type: "p",
        text: "Stock value is the current quantity multiplied by cost across all products.",
      },
      {
        type: "note",
        text: "Completing a booking automatically deducts the quantities linked to that service. You can still make manual stock adjustments when you need to correct a count.",
      },
    ],
  ...
  },
  {
    ...
    blocks: [
      {
        type: "p",
        text: "Choose Scan photo on the Stock page, then take or upload a clear photo with product labels facing the camera. The image is compressed for analysis and isn't saved to your salon gallery.",
      },
      {
        type: "p",
        text: "The scan always opens a review first. Edit any product name, brand, category, unit or count, and untick anything you don't want to apply.",
      },
      {
        type: "note",
        text: "Nothing changes until you choose Apply reviewed stock. A matching product updates its existing count; otherwise a new stock item is created.",
      },
      {
        type: "note",
        text: "AI counts are estimates, especially when products overlap or labels are hidden. Check every quantity before applying. AI stock scanning is available on Studio.",
      },
    ],
  ...
  // ---------------------------------------------------------------------
  {
    ...
    blocks: [
      {
        type: "p",
        text: "Go to Settings → Payments and click \"Connect Stripe.\" This creates a Stripe Express account and takes you to Stripe's own onboarding flow to enter your business and payout details. Once you're done, you're returned to Bookzenvo.",
      },
      {
        type: "p",
  ...
  },
  {
    ...
    summary:
      "Choose whether bookings require a deposit, full payment, or nothing upfront.",
    blocks: [
      {
        type: "p",
        text: "Once Stripe is connected, choose a payment mode under Settings → Payments:",
      },
      {
        type: "list",
        items: [
      ...
      {
        type: "note",
        text: "This is a single setting for your whole business — you can't currently set a different deposit percentage per service.",
      },
      {
        type: "p",
  ...
  },
  {
    ...
    blocks: [
      {
        type: "p",
        text: "The Payments page lists your bookings with their payment status: Paid, Deposit paid, Unpaid, Pending, Refunded, Partially refunded, or Failed. Two summary cards show what's been collected this month and what's still outstanding.",
      },
      {
        type: "p",
        text: "Click any booking to see a breakdown of the service price, amount collected, and amount remaining.",
      },
    ],
  },
  ...
  // ---------------------------------------------------------------------
  {
    ...
    summary:
      "Revenue, bookings, staff earnings and service performance in one place.",
    blocks: [
      {
        type: "p",
  ...
  },
  {
    ...
    blocks: [
      {
        type: "p",
        text: 'Both the staff earnings and services breakdown tables have their own CSV export button. For a single clean document, use "Print / Save PDF," which produces a condensed summary — business name, date range, and your top stats, staff table and services table — ready to print or save as a PDF.',
      },
    ],
  },
  ...
  // ---------------------------------------------------------------------
  {
    ...
    blocks: [
      {
        type: "p",
        text: "Under Settings → Business, set your business name, timezone, contact email and phone, website, address, description and social handles (Instagram, Facebook, TikTok, X).",
      },
    ],
  },
  {
    ...
    blocks: [
      {
        type: "p",
        text: "Under Settings → Hours, set opening and closing times for each day of the week — you can add multiple periods per day for a split shift (e.g. closed over lunch).",
      },
      {
        type: "p",
        text: "Use the Holiday closures section to block off date ranges when your whole business is shut, such as bank holidays or a team trip.",
      },
      {
        type: "note",
        text: "These are your default hours — an individual staff member's own working hours (set on their profile) override these for that person.",
      },
    ],
  },
  {
    ...
    blocks: [
      {
        type: "p",
        text: 'The Branding tab in Settings is a signpost, not an editor — your booking page\'s colors, fonts, button style and logo are all set in Page Builder → Design. See "Customizing colors, fonts and buttons" for the full walkthrough.',
      },
    ],
  ...
  },
  {
    ...
    blocks: [
      {
        type: "p",
        text: "Settings → Gallery is where you manage the photos used on your public booking page.",
      },
      {
        type: "p",
        text: "Settings → Page content lets you edit the text and copy shown on your booking page.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    summary:
      "Control what an independent professional can do on your calendar and page.",
    blocks: [
      {
        type: "p",
        text: 'If you have independent professionals linked to your business (see "Independent professionals & chair rentals"), a Chair rentals tab appears in Settings. For each professional, you can toggle whether they appear on your calendar, whether they\'re listed on your public booking page, and whether your team can book or reschedule on their behalf.',
      },
    ],
  },
  ...
  // ---------------------------------------------------------------------
  {
    ...
    blocks: [
      ...
      {
        type: "p",
        text: "Either way, you'll get an email with a link that takes you to a screen to set a new password.",
      },
    ],
  },
  {
    ...
    blocks: [
      {
        type: "p",
        text: "Go to Settings → Account → Security and click Enable to turn on 2FA.",
      },
      {
        type: "steps",
        items: [
      ...
      {
        type: "p",
        text: "After that, signing in will prompt you for a fresh 6-digit code before you can access your workspace. If you're stuck without your authenticator, you can sign out and try again from the sign-in page.",
      },
      {
        type: "note",
        text: "There are currently no backup recovery codes, so make sure your authenticator app is backed up. You can turn 2FA off again any time from the same Security section.",
      },
    ],
    keywords: [
      "mfa",
  ...
  },
  {
    ...
    blocks: [
      {
        type: "p",
        text: "Bookzenvo only uses strictly-necessary cookies and local storage — there's no analytics or advertising tracking. The cookie banner appears on public pages, like the marketing site and booking pages, not inside your dashboard.",
      },
      {
        type: "p",
        text: 'You can Accept all, Reject non-essential, or open "Manage preferences" for more detail. Since only strictly-necessary storage is used, there\'s a single always-on toggle for it. You can revisit your choice any time via the "Cookie settings" link in the site footer.',
      },
    ],
  ...
  // ---------------------------------------------------------------------
  {
    ...
    summary:
      "Bring your team, clients, services and appointment history into Bookzenvo.",
    blocks: [
      {
        type: "p",
        text: "Open Import data from the sidebar. You'll import in four steps, in this order: Team, Clients, Services, then Appointments — appointments are imported last so they can be matched to the team and clients you've already brought in.",
      },
      {
        type: "steps",
        items: [
  ...
  },
  {
    ...
    blocks: [
      {
        type: "p",
        text: "Every import you run is saved as a batch in the Import history panel. If something came in wrong, click Undo on that batch to roll it back.",
      },
      {
        type: "note",
        text: "If you accidentally upload the same file twice, Bookzenvo recognizes it and warns you before letting you re-import it.",
      },
    ],
